...
export default () => (
    <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
         width="558.65" height="585.42" viewBox="0 0 558.65 585.42">
        <defs>
            <linearGradient id="linear-gradient" x1="342.44" y1="446.53" x2="326.67" y2="980.37"
        ...
        <path
            ...
            transform="translate(-67.17 -4.31)" fill="#5c77ff" opacity="0.18"/>
        <g>
            <path
            ...
            <path
                ...
                transform="translate(-67.17 -4.31)" fill="#fff" opacity="0.34"/>
            <path
