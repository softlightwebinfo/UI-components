...
class Calendar extends React.Component<CalendarProps> {
    ...
    private width: any;
    private style: any;
    private weekdays = moment.weekdays(); //["Sunday", "Monday", "Tuesday", "Wednessday", "Thursday", "Friday", "Saturday"]
    private weekdaysShort = moment.weekdaysShort(); // ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]
    ...
    onChangeMonth = (e, month) => this.setState({showMonthPopup: !this.state.showMonthPopup});
    ...
    render() {
        ...
        return (
            ...
            >
                <table
                    className={this.getClassName.toString()}
                >
                    <thead>
                    <tr className={this.getClassName.Children("header")}>
                        <td colSpan={5}>
                            <this.MonthNav/>
                            {" "}
                            <this.YearNav/>
                        </td>
                        <td colSpan={2} className={this.getClassName.Children("nav-month")}>
                            <FontAwesomeIcon
                                className={"prev"}
